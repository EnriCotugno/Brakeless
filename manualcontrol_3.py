...
def save_lap(output_dir, lap_buffer_csv, lap_time):
    ...
    # Generiamo un timestamp univoco (OreMinutiSecondi)
    ...
    print(f"✅ Giro completato in {lap_time:.2f}s — salvato come '{filename}'")
...
def main():
    ...
    try:
        while True:
            ...
            # Salvataggio di tutte le grandezze vettoriali richieste per una corretta fisica
